...
#define FtoQ15(x) 	((int16_t)((float)(x) >= 0.999994f ? 32767 : (float)(x) < -1.f ? -32768 : ((float)(x) * (1 << 15))))

#define MYARR				7999
#define	COUNTER_2HZ_STEP	0.001f
#define COUNTER_2HZ_CNT		(((MYARR)*COUNTER_2HZ_STEP)/2)
